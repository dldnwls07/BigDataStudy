...
# 학습의욕 수준과 시험 점수의 관계
plt.figure(figsize=(10, 6))
sns.boxplot(x='학습의욕 수준', y='시험 점수', data=data, order=['Low', 'Medium', 'High'], hue='학습의욕 수준', palette='coolwarm', dodge=False)
...
# 교사의 수준과 시험 점수의 관계
plt.figure(figsize=(10, 6))
sns.boxplot(x='교사의 수준', y='시험 점수', data=data, hue='교사의 수준', palette='viridis')
...
# 학교 종류와 시험 점수의 관계
plt.figure(figsize=(10, 6))
sns.boxplot(x='학교 종류', y='시험 점수', data=data, hue='학교 종류', palette='coolwarm')
