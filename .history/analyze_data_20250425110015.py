...
plt.xlabel('공부한 시간')
plt.ylabel('시험 점수')
plt.savefig('공부시간_시험점수_관계.png')  # 저장
plt.show()
...
plt.ylabel('시험 점수')
plt.legend()
plt.savefig('수면시간_시험점수_학습의욕수준별.png')  # 저장
plt.show()
...
plt.xlabel('공부한 시간')
plt.ylabel('시험 점수')
plt.savefig('공부시간_시험점수_학습의욕수준별_산점도.png')  # 저장
plt.show()
