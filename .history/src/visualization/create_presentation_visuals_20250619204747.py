...
def create_neural_network_architecture(output_path):
    ...
    # 레이어와 노드 수 정의
    layers = [
        {'name': 'Input Layer', 'nodes': 10},  # 입력 변수 수는 데이터에 맞게 조정
...
# 8. 학습 데이터와 테스트 데이터의 분포 비교
def create_train_test_distribution_comparison(output_path):
    plt.figure(figsize=(10, 6))
